...
namespace Adeverinte_Backend.Migrations
{
    ...
    [Migration("20240428080435_dynamic Faculties Specialities")]
    partial class dynamicFacultiesSpecialities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adeverinte_Backend.Entities.FacultyModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Adeverinte_Backend.Entities.SpecialityModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Adeverinte_Backend.Entities.SpecialityModel", b =>
                {
                    b.HasOne("Adeverinte_Backend.Entities.FacultyModel", "Faculty")
            ...
            modelBuilder.Entity("Adeverinte_Backend.Entities.Students.StudentModel", b =>
                {
                    ...
                    b.HasOne("Adeverinte_Backend.Entities.SpecialityModel", "Speciality")
                        .WithMany()
